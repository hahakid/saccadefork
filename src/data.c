...
data load_data_detection2(int n, char **paths, int m, int w, int h, int c, int boxes, int classes, int use_flip, int use_blur, int use_mixup,
    float jitter, float hue, float saturation, float exposure, int mini_batch, int track, int augment_speed, int letter_box, int show_imgs)
{
    const int random_index = random_gen();
    c = c ? c : 3;
    ...
    for (i_mixup = 0; i_mixup <= mixup; i_mixup++) {
        ...
        for (i = 0; i < n; ++i) {
            ...
            char* sub = (char *)malloc(11);// object=11 tracking=16
            sub = right(sub, filename, 10);// object=10 tracking=15

            //char* sub = (char *)malloc(num+1);
            //sub = right(sub, filename, num);


            //char *base_file = "/home/lyq/dataset/kitti/mergeimage/";
            //char *base_file = "/home/lyq/dataset/kitti/merge_image/";
            char *base_file = "/media/lyq/data/kitti/training/lidars/";
            // printf("1111\n");
            char *filename2 = join1(base_file, sub);
...
//            src2 = load_image_mat_cv(filename2, 1);
            ...
            image ai = image_data_augmentation2(src, filename2, w, h, pleft, ptop, swidth, sheight, flip, dhue, dsat, dexp,
                blur, boxes, d.y.vals[i]);
            if (i_mixup) {
                image old_img = ai;
                old_img.data = d.X.vals[i];
...
void *load_thread(void *ptr)
{
    ...
    if (a.type == OLD_CLASSIFICATION_DATA){
        ...
        *a.d = load_data_region(a.n, a.paths, a.m, a.w, a.h, a.num_boxes, a.classes, a.jitter, a.hue, a.saturation, a.exposure);
        ...
        if (a.c == 6) {
            *a.d = load_data_detection2(a.n, a.paths, a.m, a.w, a.h, a.c, a.num_boxes, a.classes, a.flip, a.blur, a.mixup, a.jitter,
        ...
        *a.d = load_data_compare(a.n, a.paths, a.m, a.classes, a.w, a.h);
        ...
        if (a.c == 6){
            // printf("1111\n");
            *(a.im) = load_image2(a.path, a.path, 0, 0, a.c);
